...
void WIFIScan(unsigned int value)
{
  ...
  for(i=0;i<value;i++)
  {
    ...
    {
      Display.clear();
      Display.drawString(0, 18, "no network found");
      Display.display();
      //while(1);
    }
    else
    {
      Display.drawString(0, 18, (String)n + " nets found");
      Display.display();
      delay(2000);
      Display.clear();
    }
...
{
    Display.clear();
    Display.drawString(0, 0, String(txNumber,DEC) + " sent done");
    Display.drawString(0, 9,  "Received " + String(rxSize,DEC));
    Display.drawString(0, 16, rxpacket);
    Display.drawString(0, 24, "With rssi " + String(Rssi,DEC));
    Display.display();
}
